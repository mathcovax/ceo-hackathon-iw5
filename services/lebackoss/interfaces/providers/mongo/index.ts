...
import { type MongoAIPrestationModel, type MongoPrestationModel } from "./models/prestation";
...
const prestationCollection = database.collection<MongoPrestationModel | MongoAIPrestationModel>("prestation");
