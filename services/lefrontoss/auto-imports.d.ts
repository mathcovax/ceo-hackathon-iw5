...
declare global {
  ...
  const randomString: typeof import('./src/utils/ramdomString')['randomString']
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { LebackossClientRoute } from './src/libs/lebackoss/index'
  import('./src/libs/lebackoss/index')
  // @ts-ignore
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly randomString: UnwrapRef<typeof import('./src/utils/ramdomString')['randomString']>
